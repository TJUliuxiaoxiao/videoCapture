...
public:
    ...
    void init(FFAFrameQueue* frmQueue_,
              FFADecoder* aDecoder_,
              FFPlayerWindow* playerWindow_);
    void stop();
    void pause();
    bool peekReady();
    void wakeAllThread();
...
private:
    ...
    QAudioSink* aSink = nullptr;//替换QAudioOutput
    QAudioFormat aFormat;
    QIODevice* aDevice;
    // QAudioDeviceInfo deviceInfo;
    QAudioDevice outputDevice;//音频输出设备
