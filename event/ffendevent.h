...
{
public:
    FFEndEvent(FFCaptureContext* captureContext,
               const std::string audioURL_[FFCaptureContextType::A_DEMUXER_SIZE],
               ...
               int audioTYPE_[FFCaptureContextType::V_DECODER_SIZE],
